...
public class GuestBookingControllers {
    ...
    public GuestBookingControllers(BookingService bookingService) {
    ...
    public ResponseEntity<BookingResponseDTO> addGuests(@PathVariable Long bookingId, @RequestBody @NotEmpty List<@Valid GuestDTO> guestDTOList){
